...
export const NAVIGATION_KEYS = [
  ...
  'ai', 'settings', 'planner', 'calendar', 'projects', 'tasks', 'reports', 'suppliers', 'billing', 'team', 'integrations', 'blacklist', 'customization', 'install', 'permissions', 'transcription' , 'pipelinesSettings'
] as const;
