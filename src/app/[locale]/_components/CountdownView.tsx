...
            <span className="font-bold text-lg hidden sm:block">{t('brandNameNav')}</span>
          </Link>
...
              <Link href="/login">{t('accessButton')}</Link>
            </Button>
          </div>
        </nav>
...
            <ThemeSwitcher />
          </div>
          <p>&copy; {new Date().getFullYear()}{t('brandNameFooter')}{t('developedBy')} <Link href="..." className="...">{t('developerName')}</Link>.</p>
        </footer>
      </div>
    </div>
  );
