...
        return { 
            tasks: null, quotes: null, sentEmails: null, receivedEmails: null, 
...
        supabase, activeTeamId, startDate, endDate, activeSources
    );
...
                             .find(e => typeof e === 'object' && e !== null && e.message)?.message ||
