// /app/(app)/comunicacio/planificador/_components/SocialPlannerClient.tsx (FITXER COMPLET I CORREGIT)
"use client";
...
import { PlusCircle, ChevronLeft, ChevronRight, GripVertical, Lock, TriangleAlert } from 'lucide-react';
...
import type { SocialPost, ConnectionStatuses } from './SocialPlannerData'; // Aquest import és correcte
    ...
    return (
        <DragDropContext onDragEnd={onDragEnd}>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className="w-full" tabIndex={isPostLimitReached ? 0 : -1}>
                            <Button onClick={openCreateDialog} className="w-full flex-shrink-0" disabled={isPostLimitReached}>
                              {isPostLimitReached ? (
                          ...
                          <TooltipContent className="max-w-xs p-3 shadow-lg rounded-lg border-2 border-yellow-400 bg-yellow-50">
                            <div className="flex flex-col gap-2">
                              ...
                              <p className="text-sm text-muted-foreground">
                                {postLimitStatus.error || t_billing('limitReachedDefault')}
                              </p>
                    ...
                    {isPostLimitReached && (
                      <Alert variant="destructive" className="border-yellow-400 bg-yellow-50 text-yellow-900">
                        ...
                        <AlertDescription className="text-xs">
                          {postLimitStatus.error || t('limitErrorDescription')}
                        </AlertDescription>
                      </Alert>
                    )}
            ...
            <CreatePostDialog 
              ...
              connectionStatuses={connectionStatuses} 
              t={t} 
              accountLimitStatus={accountLimitStatus}
