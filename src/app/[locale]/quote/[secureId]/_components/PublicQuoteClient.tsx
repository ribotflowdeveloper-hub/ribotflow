            ...
            <AlertDialog open={isRejecting} onOpenChange={setIsRejecting}>
                <AlertDialogContent>
                    ...
                    <div className="py-4">
                        ...
                        <Textarea id="rejectionReason" placeholder="Ex: El preu és massa alt, falten funcionalitats..." className="mt-2" value={rejectionReason} onChange={(e) => setRejectionReason(e.target.value)} />
                    </div>
                    <AlertDialogFooter>
