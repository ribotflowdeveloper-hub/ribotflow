...
export function SignupClient({ inviteToken, invitedEmail }: SignupClientProps) {
    const t = useTranslations('SignupPage');
    const { isPending, isGoogleLoading, errorMessage, handleEmailSignup, handleGoogleSignup } = useSignupForm(inviteToken);
                        ...
                        <form action={handleEmailSignup} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="email" name="email" type="email" placeholder={t('emailPlaceholder')} required className="pl-10" defaultValue={invitedEmail} readOnly={!!invitedEmail} />
                                </div>
